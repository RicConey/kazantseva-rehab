...
export async function PUT(request) {
    ...
    try {
        ...
        await client.query('UPDATE prices SET position = $1 WHERE id = $2', [adjacent.position, current.id]);
        await client.query('UPDATE prices SET position = $1 WHERE id = $2', [current.position, adjacent.id]);
