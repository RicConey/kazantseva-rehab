...
export default function Visceral() {
    return (
        <div className={styles.serviceContent}>
            <p>
                <span className={styles.highcolor}>Вісцеральна терапія</span> – це стародавній метод оздоровлення, який спрямований на відновлення природних функцій внутрішніх органів шляхом м’якої та глибокої мануальної роботи.
            </p>
