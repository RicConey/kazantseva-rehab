...
export default function Fitobocha() {
    return (
        <div className={styles.serviceContent}>
            <p>
                <span className={styles.highcolor}>Фітобочка</span> – це унікальна оздоровча процедура, яка використовує натуральні рослинні компоненти для комплексного впливу на організм. Під час процедури тіло занурюється в теплу пару, насичену цілющими трав'яними настоянками, відварами і ефірними оліями.
            </p>
