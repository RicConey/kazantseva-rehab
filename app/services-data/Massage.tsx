...
export default function Massage() {
  return (
    <div className={styles.serviceContent}>
      ...
      <p>
        Масаж тіла включає різноманітні техніки, які допомагають зняти м’язове напруження,
        стимулювати кровообіг, поліпшити лімфодренаж та виведення токсинів з організму. Після сеансу
        ви відчуєте легкість, свіжість і наповненість енергією.
      </p>
      <ul>
      ...
      <p>
        Масаж обличчя ефективно повертає шкірі молодість, пружність і здоровий вигляд. Завдяки
        правильно підібраним технікам, масаж:
      </p>
      <ul>
      ...
      <p>
        Міопластичний масаж – це інноваційна техніка глибокого моделюючого масажу обличчя, яка
        активно впливає на м'язи, фасції та шкірні покриви. Завдяки глибокому та точному впливу, ця
        методика дозволяє:
      </p>
      <ul>
      ...
      <p>
        <span className={styles.highcolor}>Масаж тіла та обличчя</span> – це комплексна процедура,
        що поєднує глибоке розслаблення і лікувальний ефект, спрямований на загальне оздоровлення та
        поліпшення зовнішнього вигляду шкіри.
      </p>

      <h3 className={styles.serviceHeading}>Переваги комплексного масажу тіла й обличчя:</h3>
      <p>
        Поєднання цих процедур забезпечує подвійний ефект – глибоке фізичне розслаблення та помітне
        омолодження шкіри обличчя. Комплексний підхід:
      </p>
      <ul>
      ...
      <p>
        ...
        енергією та красою завдяки комплексному масажу тіла та міопластичному масажу обличчя!
      </p>
    </div>
  );
}
