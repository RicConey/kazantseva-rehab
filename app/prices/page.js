...
const prices = [
    ...
    { service: "Дитячий загальний лікувальний масаж", duration: ["30хв", "40хв"], price: ["600грн (3-10 років)", "750грн (11-14 років)"] },
    { service: "Фітобочка", duration: ["15-20хв"], price: ["550грн"] },
    { service: "ДПДГ терапія", duration: ["60хв"], price: ["900грн (для військових знижка 50%)"] },
];
