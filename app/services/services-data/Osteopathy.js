...
export default function Osteopathy() {
    return (
        <div style={{ textAlign: 'justify', lineHeight: '1.6', fontSize: '0.95rem' }}>
            <p>
                <b>Остеопатія</b> – це комплексний і цілісний підхід до здоров'я, що ґрунтується на м’яких мануальних техніках, спрямованих на глибоке відновлення природного балансу всіх систем організму. Завдяки остеопатії можна ефективно усувати різноманітні порушення в роботі опорно-рухового апарату, нервової системи, а також поліпшити роботу внутрішніх органів.
            </p>

            <h3 style={{ fontSize: '0.95rem', fontWeight: 'bold' }}>Як працює остеопатія?</h3>
            ...
            <h3 style={{ fontSize: '0.95rem', fontWeight: 'bold' }}>Коли рекомендується звернутися до остеопата?</h3>
            <ul>
            ...
            <h3 style={{ fontSize: '0.95rem', fontWeight: 'bold' }}>Користь остеопатії:</h3>
            <ul>
            ...
            <h3 style={{ fontSize: '0.95rem', fontWeight: 'bold' }}>Остеопатія для профілактики та здорового способу життя:</h3>
            <p>
