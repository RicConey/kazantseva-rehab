...
export default function Massage() {
    return (
        <div style={{ textAlign: 'justify', lineHeight: '1.6', fontSize: '0.95rem' }}>
            ...
            <h3 style={{ fontSize: '0.95rem', fontWeight: 'bold' }}>Особливості масажу тіла:</h3>
            <p>
            ...
            <h3 style={{ fontSize: '0.95rem', fontWeight: 'bold' }}>Особливості масажу обличчя:</h3>
            <p>
            ...
            <h3 style={{ fontSize: '0.95rem', fontWeight: 'bold' }}>Міопластичний масаж обличчя:</h3>
            <p>
            ...
            <p>
                <b>Масаж тіла та обличчя</b> – це комплексна процедура, що поєднує глибоке розслаблення і лікувальний ефект, спрямований на загальне оздоровлення та поліпшення зовнішнього вигляду шкіри.
            </p>

            <h3 style={{ fontSize: '0.95rem', fontWeight: 'bold' }}>Переваги комплексного масажу тіла й обличчя:</h3>
            <p>
